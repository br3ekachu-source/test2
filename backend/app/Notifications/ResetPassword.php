...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ->subject("Восстановление пароля для вашей учетной записи sydno.ru")
            ->line('Мы получили запрос на изменение пароля для вашей учетной записи.')
    ...
    protected function resetUrl($notifiable)
    {
        ...
        return config('app.frontend_url')."/auth/reset-password?token=$this->token&email={$notifiable->getEmailForPasswordReset()}";
    }
